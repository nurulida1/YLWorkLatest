...
namespace YLWorks.Controller
{
    ...
    public class IncomeController : ControllerBase
    {
        ...
        public IncomeController(AppDbContext context, IHubContext<NotificationHub> hub)
        {
            _context = context;
            _hub = hub;
        ...
        private string GenerateIncomeNo()
        {
            return $"INC-{Guid.NewGuid().ToString()[..6].ToUpper()}";
        }
    }
