        ...
        private object MapToDto(DeliveryOrder d)
        {
            return new
            {
                ...
                ReceiverCompany  = d.ReceiverCompany != null ? new
                {
                    ...
                    d.ReceiverCompany.PrimaryContactPerson,
                    d.ReceiverCompany.SecondaryContactPerson,
                 ...
                 SenderCompany = d.SenderCompany != null ? new
                {
                    d.SenderCompany.Name,
                     ...
                     d.SenderCompany.PrimaryContactPerson,
                     d.SenderCompany.SecondaryContactPerson,
