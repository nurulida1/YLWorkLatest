...
namespace YLWorks.Controller
{
    ...
    public class ExpenseController : ControllerBase
    {
        ...
        public ExpenseController(AppDbContext context, IHubContext<NotificationHub> hub)
        {
            _context = context;
            _hub = hub;
            ...
            string? includes = null)
        {
            try
            {
                ...
                {
                    var parameter = Expression.Parameter(typeof(Expense), "u");
                    ...
                    {
                        var lambda = Expression.Lambda<Func<Expense, bool>>(finalExpression, parameter);
        ...
        public async Task<ActionResult> Delete([FromQuery] Guid id)
        {
            ...
            if (expense == null)
                return NotFound(new { Error = "Expenses not found." });
            ...
            try
            {
                ...
                await _hub.Clients.All.SendAsync("ExpenseDeleted", id);
