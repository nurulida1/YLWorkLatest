...
namespace YLWorks.Controller
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public RoleController(AppDbContext context, IHubContext<NotificationHub> hub)
        {
            _context = context;
            _hub = hub;
  ...
  string? includes = null)
        {
            try
            {
                ...
                {
                    var parameter = Expression.Parameter(typeof(Role), "u");
                    ...
                    {
                        var lambda = Expression.Lambda<Func<Role, bool>>(finalExpression, parameter);
      ...
      .ToList();
        ...
        public async Task<ActionResult> DeleteRole([FromQuery] Guid id)
        {
            ...
            try
            {
                ...
                await _hub.Clients.All.SendAsync("RoleDeleted", id);
