            ...
            <div class="col-span-4 flex justify-end">
              <div class="flex flex-col gap-2">
                ...
                <div
                  ...
                  *ngIf="quotationForm.get('signatureImageUrl')?.value"
                >
                  <img
                    [src]="quotationForm.get('signatureImageUrl')?.value"
                    class="max-w-[180px] border-b border-gray-200 mb-2"
                  />
                  <p class="text-sm font-bold">
                    {{ quotationForm.get('signatureName')?.value }}
                  </p>
...
export class QuotationForm implements OnInit, OnDestroy {
  ...
  calculateTotals() {
    ...
    const discountPercent = this.quotationForm.get('discount')?.value || 0;
  ...
  onSave(isDraft: boolean = false) {
    ...
    const action$ = this.currentId
      ...
      : this.quotationService.Create(request);
